...
function UsersFor({ follower }) {
    ...
    return (
        <>
            <div style={{ padding: "2px 1px", fontSize: "13px" }} className='d-flex mt-2 position-relative'>
                <div>
                ...
                <div className='d-flex flex-column ms-2 justify-content-center'>
                    ...
                    <p>{follower.biyography}</p>
                </div>
                <div style={{ top: "6px", right: "24px", position: "absolute" }} className=''>
                    {
