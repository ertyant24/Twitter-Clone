...
function Search() {
    ...
    return (
        <>
            <div className='d-flex' style={{ position: "sticky", fontSize: "14px", top: "2px", zIndex: "1" }}>
                ...
                <input
                    ...
                    autoComplete='off'
                />
                <i id='mark' onClick={removeInput} style={{ fontSize: "18px", color: " #0688af", cursor: "pointer", visibility: ara !== "" ? "visible" : "hidden", position: "absolute", top: "10px", right: "14px" }} className="fa-solid fa-circle-xmark ms-auto"></i>
                {
